...
{
    	innerModel= new InnerModel ( "/home/brickbit/robocomp/files/innermodel/informatica-tercio.xml" );
	...
	switch (estado)
			{	
				case State::SEARCH:	
					...
					{	
						qDebug()<<"Son iguales tag y current";
					...
					break;
				case State::GO:
					qDebug()<<"Entrando en go"<<gotopoint_proxy->atTarget();
...
void SpecificWorker::newAprilTag(const tagsList &tags)
{
	...
	tag.transform(tags.front().tx, tags.front().tz, tags.front().id);
